...
<div class="wizard-map" markdown>

<div class="wizard-step" markdown>
**Paso 1 · El proyecto en 5 minutos**
Qué se está postulando, por qué importa, dónde se postula, plazo de cierre.
[→ Empezar](1-el-proyecto.md)
</div>

<div class="wizard-step" markdown>
**Paso 2 · Estado actual**
Lo que ya está hecho, lo que falta, los riesgos críticos abiertos.
</div>

<div class="wizard-step" markdown>
**Paso 3 · Lo crítico de ti**
Las 5 decisiones científico-metodológicas que dependen de tu firma.
</div>

<div class="wizard-step" markdown>
**Paso 4 · La propuesta de investigación**
Pregunta, objetivos, diseño metodológico, el cuaderno como dispositivo.
</div>
...
Calendario con plazos y decisiones bloqueantes hasta el cierre.
</div>
...
!!! warning "Lo que NO te toca"
    Presupuesto, Gantt operativo, articulación MINERD/INDOTEL/BID, gestión administrativa ANII, submission técnica del formulario. Eso es de Sebas como Director del proyecto.

---

<div class="wizard-cta" markdown>
[Empezar el recorrido — Paso 1 →](1-el-proyecto.md){ .md-button .md-button--primary .md-button--lg }
</div>
