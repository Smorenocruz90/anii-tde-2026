...
<div class="wizard-progress" markdown>
  <div class="wizard-progress-label">Paso 1 de 6 · El proyecto en 5 minutos</div>
  <div class="wizard-progress-bar"><div class="wizard-progress-fill" style="width: 16%"></div></div>
</div>
...
```mermaid
graph LR
    BER[👩‍🏫 Berenice<br/>PI · única T-C<br/>tu universidad]
    JR[🎓 Junior<br/>a contratar<br/>bajo tu mentoría]
    SEB[👨‍💼 Sebas<br/>Director · admin]
    AGU[👩‍🎨 Agus<br/>pedagogía + UX]
    STE[👨‍💻 Steven<br/>data engineering]

    BER --> CIE[Decisiones científicas<br/>+ análisis + manuscrito]
    JR --> CIE

    SEB --> OPE[Operación + presupuesto<br/>+ MINERD/BID/ANII]
    AGU --> OPE
    STE --> OPE

    style BER fill:#e8f5e9,stroke:#2e7d32,stroke-width:3px
    style JR fill:#e8f5e9,stroke:#2e7d32
    style CIE fill:#e3f2fd
