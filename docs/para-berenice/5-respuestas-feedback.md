...
<div class="wizard-progress" markdown>
  <div class="wizard-progress-label">Paso 5 de 6 · Cómo se resolvió cada observación</div>
  <div class="wizard-progress-bar"><div class="wizard-progress-fill" style="width: 83%"></div></div>
</div>
...
<div class="feedback-summary" markdown>

<div class="feedback-stat success" markdown>
**17 / 17**
Observaciones abordadas
</div>

<div class="feedback-stat warning" markdown>
**3**
Con tensión pendiente del panel
</div>

<div class="feedback-stat info" markdown>
**0**
Sin resolver
</div>
...
| # | Tema | Resuelta en | Estado |
|:---:|------|-------------|:------:|
| 1 | Pregunta compuesta | Pregunta principal + 2 sub-preguntas | ✅ |
| 2 | Objetivo sobre-prometido | 4.2.1 reescrito sin "agencia + soberanía + protocolo regional" | ✅ |
| 3 | N apretado para análisis prometidos | 4.3.1 exploratorios + 4.7.2 contingencia | 🟡 |
| 4 | SJT-POV sin validación como variable central | 4.3.1 reposicionado como caracterización | ✅ |
| 5 | Claridad conceptual de variables e instrumentos | 4.3.1 alineado al modelo de niveles | ✅ |
| 6 | Intervención pedagógica sin def operativa | 4.1.1 marco teórico + 4.5.1 detalle | ✅ |
| 7 | Uso pedagógico real no demostrado por logs | N4 modelo niveles + 4.5.1 mini-retos | ✅ |
| 8 | Mecanismo de apropiación no explicado | Modelo niveles + 4.5.1 dispositivo | ✅ |
| 9 | Diagnóstico RD con datos duros | 4.1.1 con TALIS + Ceibal + SICA | ✅ |
| 10 | "Paper publicado" → "manuscrito sometido" | 4.5.3 + 4.7.2 + 4.9.2 | ✅ |
| 11 | Framework Criter demasiado visible | 4.1.1 sin mención + honest broker | 🟡 |
| 12 | No diferencian adopción/uso/apropiación | Modelo de 5 niveles | ✅ |
| 13 | Lenguaje causal sin diseño causal | Toda la propuesta usa "asociaciones" | 🟡 |
| 14 | Generalización regional sobreestimada | 4.5.2 transferencia metodológica | ✅ |
| 15 | Sub-cohorte docente Soy Digital | 4.1.2 explícito | ✅ |
| 16 | Implicaciones aplicadas | 4.6 + 4.7.1 + 4.9.1 | ✅ |
| 17 | Cuaderno como dispositivo metodológico | 4.5.1 con 7 sub-preguntas | ✅ |

🟡 = resuelta en v2.0 pero con observación adicional del panel /review-grant que requiere refinamiento.
...
??? success "2. Objetivo general sobre-prometido"
    ...
    **Dónde:** [Tablero → 4.2.1 Objetivo general](../tablero/checklist-anii.md#421-objetivo-general)
...
??? warning "13. Lenguaje causal sin diseño causal · TENSIÓN PENDIENTE"
    ...
    **Tensión pendiente del panel:** la línea D.II del llamado pide *"evidencia sobre qué estrategias resultan más efectivas"*. El panel señala que falta defender explícitamente el pivot a lenguaje no causal en 4.5.1. **Recomendación:** agregar un párrafo justificativo.
...
??? success "17. Sección dedicada al cuaderno digital como dispositivo metodológico"
    ...
    **Resolución v2.0:** 4.5.1 (432/500 palabras) es esa sección, con las 7 sub-preguntas respondidas. Responde explícitamente a:
    ...
    1. ¿Qué es el cuaderno? — entorno estructurado con 6 acciones primarias
    2. ¿Para qué? — captura de Labeling Cognitivo + machine teaching
    3. ¿Usos previos? — implementación inmutable congelada de Criter Academy
    4. ¿Qué captura el log? — eventos append-only con tipo, ID anonimizado, momento, bloque, payload
    5. ¿Cómo se interpretan pedagógicamente? — 4 categorías ancladas en literatura
    6. ¿Relevancia D.II? — evidencia granular de proceso vs adopción declarativa
    7. ¿Punto de innovación? — esquema de captura semánticamente codificada, no el cuaderno en sí

    **Dónde:** [Tablero → 4.5.1](../tablero/checklist-anii.md#451-contribucion-a-la-resolucion-del-problema-done)
...
??? success "7. Uso pedagógico real no demostrado por logs"
    ...
    **Resolución v2.0:** Nivel 4 del modelo separado explícitamente, con tres instrumentos diferenciados:
    ...
    - **Mini-retos quincenales** con artefactos del aula (foto, audio, descripción)
    - **Autorreporte estructurado** de aplicación
    - **Entrevistas semiestructuradas** en sub-muestra N=18 al cierre
...
??? success "9. Diagnóstico RD necesita datos duros y justificación de caso"
    ...
    **Resolución v2.0:** 4.1.1 incluye:
    ...
    - **OCDE-TALIS 2024:** 29% de docentes OCDE reporta IA como mayor necesidad de DPC
    - **Ceibal 2026:** diagnóstico de 25 países ALC, Formación Docente entre los 2 peores pilares
    - **SICA 2020:** RD con certificación 88-95% pero baja madurez (2,29 capacidad pedagógica, 2,13 equidad, 2,27 LL)
    - **Posicionamiento de RD** como "caso revelador" con esa configuración específica
...
??? success "15. Alfabetización digital ciudadana ≠ competencia digital docente"
    ...
    **Resolución v2.0:** 4.1.2 explicita:
    ...
    - **Identificación:** autorreporte de ocupación en registro Soy Digital + cruce con padrones MINERD
    - **Segmento explícito** orientado a docentes y formadores dentro de Soy Digital
    - **Adaptación de foco:** curso piloto específico alineado al UNESCO AI Competency Framework for Teachers (2024), diferenciado del currículo general de alfabetización digital ciudadana

    **Pendiente:** % exacto docentes dentro de los 100K aún no especificado (Sebas está gestionando dato).
...
??? warning "11. Framework Criter demasiado visible → percepción de sesgo · TENSIÓN PENDIENTE"
    ...
    **Resolución v2.0:**
    ...
    - 4.1.1 NO menciona Criter — las 4 categorías se anclan en literatura externa primero
    - 4.5.1 menciona Criter UNA SOLA VEZ como "implementación específica utilizada", no como protagonista
    - Honest broker explicado en 4.5.4 + 4.7.2
    - Pre-registro OSF + dataset abierto + declaración explícita en 4.7.2 (riesgos)

    **Tensión pendiente del panel:** la mitigación cubre el análisis pero NO el diseño. **El panel recomienda trasladar también el design lock** a la universidad participante o a un comité asesor externo. Es la [decisión #2 tuya](3-lo-critico.md#decisión-2--alcance-del-honest-broker), deadline 27 may.
...
??? success "16. Explicitar implicaciones para política y diseño"
    ...
    **Resolución v2.0:**
    ...
    - **Tabla 4.6 IMPACTOS** con 5 filas separadas por audiencia (investigadores, equipos regionales, hacedores de política, capacidades locales, agencia docente)
    - **4.7.1 OTRAS CONTRIBUCIONES** con 5 contribuciones adicionales
    - **4.9.1 DIVULGACIÓN** con reporte ejecutivo dirigido a MINERD, INDOTEL, BID-RD, Fundación Ceibal

---

## Lo que se mantuvo de v1.1 (sin tocar)

- Estrategia de IP (background vs foreground, 6 capas en 4.8)
- Tres pilares de A.2 (Soy Digital, Comfama, Berenice + universidad participante)
- Línea D.II principal + C secundaria
- Diseño mixto convergente longitudinal corto 12 semanas
- Estructura de presupuesto con topes ANII
- Cronograma de 6+3 meses
- Equipo y figura jurídica con escenarios

---

<div class="wizard-nav" markdown>
[← Paso 4 · La propuesta](4-la-propuesta.md){ .wizard-prev }
[Paso 6 · Próximos pasos →](6-proximos-pasos.md){ .wizard-next }
</div>
